class person{
  ...
  age=18;
  static total=0
  constructor(name,email,age,colaboracion,url,linkgit){
      this.name=name;
      this.email = email;
      this.age = age;
        ...
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <div class="btn-group" role="group" aria-label="Basic example">
              ...
              <a class="btn btn-primary btn-lg disabled" role="button" aria-disabled="true"><i class="bi bi-linkedin"></i> </a>
...
if(a==1){
  ...
  celulares con Python, dominio  de HTML, CSS, Boostrap y Javascript  `,
    "../src/images/PérezElizondo.jpg" ,"https://github.com/jart2222")
    ...
    "../src/images/DaisySarahí.jpg","https://github.com/dmatmo")
    ...
    `,"../src/images/OscarMartínez.jpg","https://github.com/OscarMtz1111")
    ...
    "../src/images/PérezElizondo.jpg","https://github.com/ElizOct98")
    Saul.printInfo(divP);
    ...
    `,
    "../src/images/RodrigoNiebla.jpg","https://github.com/iRoooooo")
    Daisy.printInfo(divP);
}
else if(a==8){
    let divP=document.getElementById("modal1")
