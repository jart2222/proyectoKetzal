    ...
    `                   <div class=" col-sm-12 col-md-12 col-lg-6">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item list-group-item-danger">
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal${idP}">
                                        Editar
                                    </button>
                                </li>
                            </ul> 
                        ...
                        <div class="modal fade" id="exampleModal${idP}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                            <div class="modal-dialog modal-xl">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Editor de Producto con Id ${idP}</h5>
...
function actualizar_boton(idP){
    let idU=idP
    let nombreU=document.getElementById(`nombreU${idP}`).value;
    console.log(nombreU);
    let imagenU= document.getElementById(`imagenU${idP}`).value;;
    let productoU=document.getElementById(`descripcionU${idP}`).value;
    let precioU= document.getElementById(`precioU${idP}`).value;
    let gramajeU= document.getElementById(`cantidadU${idP}`).value;
