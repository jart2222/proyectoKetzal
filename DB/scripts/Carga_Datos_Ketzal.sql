...
INSERT INTO `Ketzal`.`clientes` (`idcontacto`, `nombre`, `correo`, `telefono`, `contrasena`) VALUES (6, 'Administrador', 'admin@gmail.com', '0123456789', 'ketzal1'); 
 
 -- Datos Producto 
 
INSERT INTO `Ketzal`.`productos` (`idproductos`, `nombre`, `imagen`, `descripcion`, `precio`, `gramaje`) VALUES (1, 'Café Honduras', 'cafeHonduras.jpeg', 'Café 100% de café arábica, con una producción ecológicamente sostenible. Suelen ser dulces, achocolatados, con cuerpo redondo, acidez delicada y postgusto sostenido. Perfecto para esos días de descanso.', '360.00', '180'); 
INSERT INTO `Ketzal`.`productos` (`idproductos`, `nombre`, `imagen`, `descripcion`, `precio`, `gramaje`) VALUES (2, 'Café Borundi', 'cafeBorundi.jpeg', 'Café de grano cosechado a mano y secado al sol en parihuelas elevadas. Se pueden identificar notas de frutas, flores y miel, acompañadas de consistencia, equilibrio y un cuerpo completo. Perfecto para iniciar tus mañanas.', '399.00', '200'); 
INSERT INTO `Ketzal`.`productos` (`idproductos`, `nombre`, `imagen`, `descripcion`, `precio`, `gramaje`) VALUES (3, 'Café Guatemala', 'cafeGuatemala.jpeg', 'Este preparado gourmet es una mezcla arábiga aromática, El grano es cosechado a la sombra. Es delicioso, con pronunciada acidez cítrica y mucho cuerpo. Perfécto para compartir con amigos.', '350.00', '210'); 
INSERT INTO `Ketzal`.`productos` (`idproductos`, `nombre`, `imagen`, `descripcion`, `precio`, `gramaje`) VALUES (4, 'Café Indonesia', 'cafeIndonesia.jpeg', 'Está considerado como uno de los mejores del mundo, es un café Arábica procesado húmedo. Es bastante dulce y de baja acidez, de cuerpo medio y aroma complejo a tierra. Ideal para esos días especiales.', '499.00', '150'); 
INSERT INTO `Ketzal`.`productos` (`idproductos`, `nombre`, `imagen`, `descripcion`, `precio`, `gramaje`) VALUES (5, 'Café Mimba', 'cafeMimba.jpeg', 'Café liofilizado hecho con granos cosechados a mano a nivel del mar. Es apreciado por su dulce fragancia, acidez cítrica, sabores dulces y un cuerpo cremoso que la hacen muy agradable. Lo mejor para los días de trabajo.', '499.00', '250'); 
INSERT INTO `Ketzal`.`productos` (`idproductos`, `nombre`, `imagen`, `descripcion`, `precio`, `gramaje`) VALUES (6, 'Café Mujeres', 'cafeMujeres.jpeg', 'Café en grano que se cultiva en laderas empinadas, bajo la sombra de árboles y plantas que permiten una maduración más lenta. Es de acidez media y mucho cuerpo, con notas a chocolate y avellana. El mejor para compartir con esa persona especial.', '219.00', '200'); 
INSERT INTO `Ketzal`.`productos` (`idproductos`, `nombre`, `imagen`, `descripcion`, `precio`, `gramaje`) VALUES (7, 'Café Perú', 'cafePeru.jpeg', 'Café Arábica, de las mejores cosechas debido a la privilegiada ubicación de Perú. Caracterizados por su cuerpo y notas herbáceas, pero con más dulzor. Delicioso para compartir en familia.', '299.00', '220'); 
INSERT INTO `Ketzal`.`productos` (`idproductos`, `nombre`, `imagen`, `descripcion`, `precio`, `gramaje`) VALUES (8, 'Café Pétalo', 'cafePetalo.jpeg', 'Café robusta, cosechado 100% por familias de las mejores regiones de Perú. Agradable sabor a cítricos, albaricoques y caramelo y acidez tartárica. Lo mejor para esos momentos difíciles.', '279.00', '140'); 
INSERT INTO `Ketzal`.`productos` (`idproductos`, `nombre`, `imagen`, `descripcion`, `precio`, `gramaje`) VALUES (9, 'Café Tziscao', 'cafeTziscao.jpeg', 'Café granos 100% arábica y orgánico, el tostado del cafés está elaborado en pequeños lotes, con el mayor de los cuidados, con sabor achocolatado y tonos a almendras tostadas, con un aroma y cuerpo intenso. Tu mejor aliado para esos viajes largos.', '349.00', '125');
